...
iabbr ccopy Copyright 2018 Leon Cheng, all rights reserved.
iabbr @@ laohan1221@126.com 
let &cpo=s:cpo_save
unlet s:cpo_save
...
nnoremap <buffer> ,8 :w|!python %:r.py
...
silent! normal! zE
let s:l = 31 - ((15 * winheight(0) + 20) / 41)
